package com.Binde.hive.security.auth;
...
import com.Binde.hive.repository.UserRepository;
import com.Binde.hive.utils.EmailTemplates;
import com.Binde.hive.utils.StringUtil;
import com.Binde.hive.security.JwtService;
import com.Binde.hive.security.TokenResponse;
...
import static com.Binde.hive.constant.SecurityConstants.PASSWORD_NOT_MATCH_MSG;
...
public class AuthController {
    ...
    private void validateUserRegistration(UserRegistrationRequestDto registrationRequestDto) {
        ...
        if (!StringUtil.doesBothStringMatch(registrationRequestDto.getConfirmPassword(), registrationRequestDto.getPassword())) {
