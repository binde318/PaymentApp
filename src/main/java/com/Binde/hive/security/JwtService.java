package com.Binde.hive.security;
...
import com.Binde.hive.constant.SecurityConstants;
...
public class JwtService {
    ...
    public static TokenResponse generateToken(Authentication authentication, com.Binde.hive.entity.User currentUser) {
